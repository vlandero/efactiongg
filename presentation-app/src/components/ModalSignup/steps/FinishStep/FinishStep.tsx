    ...
    <div className="flex flex-col items-center justify-center gap-6 text-center text-light max-w-xl mx-auto min-h-[400px]">
      ...
      <div>
        ...
        <p className="text-m text-neutral-400 max-w-md">
          You’re ready to roll. Everything is set up—just click below to head to
          your dashboard and start managing your faction.
        </p>
      </div>

      <Button
        onClick={() =>
          router.replace("https://cyberpunk-esports-efactiongg.vercel.app/")
        }
